...
export default function DealerCustomers() {
  ...
  return (
    <div>
      <PageHeader title="Customers" subtitle="View and manage your customer relationships" breadcrumbs={[{ label: 'Dealer' }, { label: 'Customers' }]} />
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded overflow-hidden">
        <Table
          ...
          columns={[
            ...
            { key: 'joined', header: 'Since', render: c => <span className="text-zinc-500 text-xs font-mono">{formatDate(c.createdAt)}</span> },
          ]}
        />
